...
public final class ConfiguracaoRede {
    ...
    public String obterEnderecoDns() {
        return obterTexto("endereco.dns", "localhost");
    }
    ...
    public int obterPortaDns() {
        return obterNumero("porta.dns", 5300);
    }

    public int obterPortaBalanceador() {
        return obterNumero("porta.balanceador", 5500);
    }

    // ---- Registro de nomes usado pelo "DNS" simplificado ----

    public String obterRegistroDnsPrimario() {
        return obterTexto("dns.primario", obterEnderecoPrimario() + ":" + obterPortaClientes());
    }

    public String obterRegistroDnsReplica() {
        return obterTexto("dns.replica", obterEnderecoReplica() + ":" + obterPortaClientes());
    }

    // ---- Lista de backends do balanceador de carga (host:porta,host:porta,...) ----

    public String obterBackendsBalanceador() {
        return obterTexto("balanceador.backends", "localhost:8080,localhost:8080");
    }
}
